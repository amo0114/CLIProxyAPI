...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/quotas/opencode-go", s.mgmt.ListOpenCodeGoQuotas)
		mgmt.POST("/quotas/opencode-go/refresh", s.mgmt.RefreshOpenCodeGoQuotas)
		mgmt.POST("/quotas/opencode-go/:id/refresh", s.mgmt.RefreshOpenCodeGoQuota)
		...
		mgmt.POST("/auth-files/opencode-go", s.mgmt.CreateOpenCodeGoCredential)
